...
export default function ValidationsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Validations en attente</h1>
        <p className="text-gray-505 dark:text-gray-400">Vérifiez les documents des nouveaux partenaires</p>
      </div>
          ...
          {users.length === 0 ? (
            <div className="bg-white dark:bg-gray-900 p-12 rounded-2xl border border-gray-100 dark:border-gray-800 text-center">
              <div className="w-16 h-16 bg-gray-50 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
                <CheckCircle2 className="h-8 w-8 text-emerald-300 dark:text-emerald-500" />
              </div>
              <p className="text-gray-500 dark:text-gray-400 font-medium">Tout est à jour !</p>
              <p className="text-sm text-gray-400 dark:text-gray-500">Aucune validation en attente pour le moment.</p>
            </div>
          ) : (
            users.map((user) => (
              <div 
        ...
        <div className="space-y-6">
          {selectedUser ? (
            ...
            <div className="bg-gray-50 dark:bg-gray-900/40 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-2xl p-12 text-center text-gray-400 dark:text-gray-500 sticky top-8">
              Sélectionnez un utilisateur pour voir les détails et valider son accès.
            </div>
          )}
        </div>
      </div>
